...
export default class GraficoTemperatura extends Component {
    ...
    loadItens = async (page = 0) => {
        ...
        let url = '/eventos?mac=' + mac + '&t=TMP&size=' + pageSize + '&sort=dataHora,desc&page=' + page;
...
<Grid stackable columns={2} >
                    <Grid.Column>
                        <Header as="h2" > {text("relatorio-dispositivos.temperatura-historico")}</Header>
                    </Grid.Column>
                    ...
                    <>
                        <ResponsiveContainer height={400}>
                            ...
                            >
                                ...
                                <YAxis domain={[-30, 50]}  />
                                <Tooltip />
                                <Line stroke="#FF0000" type="monotone" dataKey="dado" name={text("relatorio-dispositivos.temperatura")} />
                            </LineChart>
                        </ResponsiveContainer>
                    </>
                  ) : (
