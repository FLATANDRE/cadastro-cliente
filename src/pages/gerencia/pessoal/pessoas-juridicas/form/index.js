...
import { Button, Form, Header, Divider, Icon, Dropdown } from 'semantic-ui-react';
...
class PessoasJuridicasForm extends Component {
    ...
    async componentDidMount() {
        ...
        if (this.props.match.params.id) {
            ...
            const response = await api.get("/pessoal/pessoas-juridicas/" + id);
    ...
    render() {
        ...
        const { pessoa, loading } = this.state;

        if (this.props.sucessoInsert) {
            return <Redirect to={{
                pathname: '/gerencia/pessoal/pessoas-juridicas',
            ...
            <div>
                ...
                <Formik
                    initialValues={{
                        ...
                        cnpj: pessoa ? pessoa.cnpj : '',
                        nomeFantasia: pessoa ? pessoa.nomeFantasia : '',
                        inscricaoEstadual: pessoa ? pessoa.inscricaoEstadual : '',
                        ...
                        setFieldValue
                            ...
                            >
                                <Form.Group widths='equal'>
                                    ...
                                    <div className="field">
                                        <label>{text("pessoa.nome-fantasia")}</label>
                                        <InputText
                                            onChange={handleChange}
                                            onBlur={handleBlur}
                                ...
                                <Form.Group widths='equal'>
                                    ...
                                    <div className="field">
                                        <label>{text("pessoa.incricao-estadual")}</label>
                                        <InputText
                                            onChange={handleChange}
                                            onBlur={handleBlur}
                                ...
                                <Button
                                    ...
                                    size='large'
                                    as={Link}
                                    to="/gerencia/pessoal/pessoas-juridicas"
...
const mapDispatchToProps = dispatch => {
    return {
        addPessoa: (pessoa) => dispatch(addPessoa(pessoa, pessoaTypes.PESSOA_JURIDICA)),
        editPessoa: (pessoa) => dispatch(editPessoa(pessoa, pessoaTypes.PESSOA_JURIDICA)),
        resetStates: (pessoa) => dispatch({ type: RESET_STATES_PESSOA }),
    };
};

export default connect(mapStateToProps, mapDispatchToProps)(PessoasJuridicasForm);