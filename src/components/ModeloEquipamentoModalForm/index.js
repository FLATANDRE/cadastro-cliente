...
function ModeloEquipamentoModalForm({condicaoContratual, 
                          contrato, 
                          modelo,
                          listaModelo,
                          isInserindo, 
    ...
    return (
        ...
        <Form.Group>
            <Button
                ...
                onClick={() => handleShowModelo(tiposObjetoContratado.equipamento)}
            >
                <Icon name='plus' /> 
                {text("geral.adicionar") + " " + 
                text("contrato.modelo") + " " + 
                text("contrato.equipamento")}
            </Button>
            <Modal
                onClose={() => handleClose(tiposObjetoContratado.equipamento)}
                open={isOpen}
                closeIcon
                centered={true}
                size={'large'}>
                <Modal.Header>
                    {text("geral.adicionar") + " " + text("contrato.modelo") + " " + text("contrato.equipamento") + " "} 
                ...
                <Modal.Content >
                        ...
                        <Form.Group widths='equal'>
                            <div className="field required">
                                ...
                                <Dropdown
                                    ...
                                    search
                                    fluid
                                    value={modelo.modeloEquipamento ? modelo.modeloEquipamento : ""}
                                    onChange={(e, { value }) => setField('modelo', tiposObjetoContratado.equipamento, value)}
                                    name="modelo"
                                />
                            </div>                 
                              
                            <div className="field required">
                                <label>{text("contrato.intervalo-manutencao-nao-obrigatoria")}&nbsp;{text("contrato.valor-em-meses")}</label>
                                <InputText
                                    name="intervaloManutencaoNaoObrigatoria"
                                    autoComplete={"off"}
                                    onBlur={(e) => setField('intervaloManutencaoNaoObrigatoria', tiposObjetoContratado.equipamento, e)}
                                />
                            </div>
                            <div className="field required">
                                <label>{text("contrato.intervalo-calibracao")}&nbsp;{text("contrato.valor-em-meses")}</label>
                                <InputText
                                    name="intervaloCalibracao"
                                    autoComplete={"off"}
                                    onBlur={(e) => setField('intervaloCalibracao', tiposObjetoContratado.equipamento, e)}
                                />
                            </div>   
                        </Form.Group>
                        ...
                        <Form.Group widths='equal'>
                            <div className="field required">
                                ...
                                <InputText
                                    ...
                                    onChange={(e) => setField('quantidadeContratada', tiposObjetoContratado.equipamento, e)}
                                />
                            </div>

                            <div className="field required">
                                <label>{text("contrato.tempo-max-keep-alive")}&nbsp;{text("contrato.valor-em-dias")}</label>
                                <InputText
                                    name="tempoMaxKeepAlive"
                                    keyfilter={"int"}
                                    autoComplete={"off"}
                                    value={modelo.tempoMaxKeepAlive}
                                    onChange={(e) => setField('tempoMaxKeepAlive', tiposObjetoContratado.equipamento, e)}
                                />
                            </div>
                        </Form.Group>
                        ...
                        <Form.Group widths='equal'>
                            <div className="field required">
                                ...
                                <CurrencyFormat
                                    ...
                                    onChange={(e) => setField('precoInstalacao', tiposObjetoContratado.equipamento, e)}
                            ...
                            <div className="field required">
                                ...
                                <CurrencyFormat
                                    ...
                                    onChange={(e) => setField('precoManutencao', tiposObjetoContratado.equipamento, e)}
                        ...
                        <Form.Group widths='equal'>
                            <div className="field required">
                                ...
                                <CurrencyFormat
                                    ...
                                    onChange={(e) => setField('precoVenda', tiposObjetoContratado.equipamento, e)}
                            ...
                            <div className="field required">
                                ...
                                <CurrencyFormat
                                    ...
                                    onChange={(e) => setField('precoAluguel', tiposObjetoContratado.equipamento, e)}
                            ...
                            <div className="field required">
                                ...
                                <CurrencyFormat
                                    ...
                                    onChange={(e) => setField('precoServico', tiposObjetoContratado.equipamento, e)}
                    ...
                    <div style={{ marginBottom: "50px" }}>
                        <Button
                            ...
                            labelPosition='left'
                            size="medium"
                            onClick={() => handleClose(tiposObjetoContratado.equipamento)}
                        >
                        ...
                        <Button
                            ...
                            onClick={() => handleAddModelo(tiposObjetoContratado.equipamento)}
                        >
            ...
            <Table celled striped selectable >
                <Table.Header>
                    <Table.Row>
                        ...
                        <Table.HeaderCell>{text("contrato.intervalo-manutencao-nao-obrigatoria")}</Table.HeaderCell>
                        <Table.HeaderCell>{text("contrato.intervalo-calibracao")}</Table.HeaderCell>                          
                        <Table.HeaderCell>{text("contrato.qtd-contratada")}</Table.HeaderCell>
                        <Table.HeaderCell>{text("contrato.tempo-max-keep-alive")}</Table.HeaderCell>
                        ...
                        listaModelo.length > 0 &&
                            ...
                            <Table.Row key={index} >
                                <Table.Cell style={{ textAlign: "center" }}>
                                    {modelo['modeloDispositivo'] ? modelo['modeloDispositivo'].nome : modelo['modeloEquipamento'].nome}
                                </Table.Cell>
                                <Table.Cell style={{ textAlign: "center" }}> {modelo.intervaloManutencaoNaoObrigatoria}</Table.Cell>
                                <Table.Cell style={{ textAlign: "center" }}> {modelo.intervaloCalibracao}</Table.Cell>
                                <Table.Cell style={{ textAlign: "center" }}>{modelo.quantidadeContratada}</Table.Cell>
                                <Table.Cell style={{ textAlign: "center" }}>{modelo.tempoMaxKeepAlive}</Table.Cell>
                                <Table.Cell style={{ textAlign: "center" }}>
                                    <CurrencyFormat
                                ...
                                <Table.Cell>
                                    <Button
                                        ...
                                        icon
                                        size='mini'
                                        onClick={() => handleRemoveModelo(index, tiposObjetoContratado.equipamento)}
                                    > <Icon name='delete' />
                                    </Button>
                                </Table.Cell>
                            </Table.Row>
...
export default ModeloEquipamentoModalForm;